...
<a><img>字字字</a> 超链接后接图片,接字.方便字在更改的时候修改,具体方法:1对超链接定位(可以display为block)  .2 然后对图片设置margin
...
如果桌椅想跳转到桌椅  直接给桌椅上超链接<a href=”#zuoyi”然后在桌椅整个的cantainer 上的class=”container-zuoyi”  id=zuoyi这样 点座椅就会跳转到cantainer上
...
</html> 只有这样在h1 之间镶嵌文字的才能对h1 所使用textalign 同理textindent也是这样
